...
//                                 <li>
//                                     <NavLink to='/rolelist' className='pl-2 block py-1 rounded-md hover:text-white hover:bg-blue-600' onClick={() => setShowDropdown(false)}>
//                                         Role List
//                                     </NavLink>
//                                 </li>
                              
//                                 <li>
//                                     <NavLink to='/addrole' className='pl-2 block py-1 rounded-md  hover:text-white hover:bg-blue-600' onClick={() => setShowDropdown(false)}>
//                                         Role Add
//                                     </NavLink>
//                                 </li>
//                                 <li>
//                                     <NavLink to='/editrole' className='pl-2 block py-1 rounded-md  hover:text-white hover:bg-blue-600' onClick={() => setShowDropdown(false)}>
//                                     Role Edit
//                                     </NavLink>
//                                 </li>
//                             </ul>
