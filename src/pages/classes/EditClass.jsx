    ...
    return (
        <div className='container bg bg-gray-100 h-screen w-full overflow-hidden'>
            <div className='flex justify-between'>
                <h1 className='pl-8  pt-4 font-semibold text-2xl'> Edit Classes</h1>
                <div className="flex">
                    <h1 className='pr-2 pt-4 font-semibold text-md'>
                        <Link to='/studentlist'>Class</Link>
                    </h1>
                    <h1 className='flex justify-end mt-4  pr-6 font-semibold text-md'>/Edit Classes</h1>
                </div>
            </div>
