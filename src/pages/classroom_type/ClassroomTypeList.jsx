    ...
    return (
        ...
        <div className='container bg-gray-100 h-screen w-full overflow-hidden '>
            <div className='flex justify-between'>
                <h1 className='pl-8 pt-4 font-semibold text-2xl'>Classrooms</h1>
                <h1 className='pr-6 pt-4 font-semibold text-md'>Classrooms / All Classrooms</h1>
            </div>
