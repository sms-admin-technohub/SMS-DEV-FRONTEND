    ...
    return (
        <div className='container bg bg-gray-100 h-screen w-full overflow-hidden'>
            <div className='flex justify-between'>
                <h1 className='pl-8  pt-4 font-semibold text-2xl'> Edit Period</h1>
                <div className="flex">
                    <h1 className='pr-2 pt-4 font-semibold text-md'>
                    Period
                    </h1>
                    <h1 className='flex justify-end mt-4  pr-6 font-semibold text-md'>/Edit Periods</h1>
                </div>
            </div>

            <div className='form bg-white mt-8  mx-6 rounded-lg'>
                <div className='text text-start pl-3 pt-4 font-semibold text-xl'><h1>Periods Information</h1></div>
